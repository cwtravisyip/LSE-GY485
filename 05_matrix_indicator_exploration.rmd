...
I saw from the documentation that I can specify the "break" argument in the state_density2d function, passing in a function that takes the kernel density output and return the breaks as output. How can I specify the function?
```{r}
# density map data
...
for (path in satellite_paths[1:5]){
...
df
# write.csv(df, "./data/spmkt_spec_satellite.csv")
```
